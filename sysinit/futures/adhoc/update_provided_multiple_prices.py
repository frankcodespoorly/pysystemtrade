...
roll_calendars_from_arctic = os.path.join(os.sep, 'home', 'prd', 'data', 'futures', 'roll_calendars_from_arctic')
if not os.path.exists(roll_calendars_from_arctic):
    os.makedirs(roll_calendars_from_arctic)

multiple_prices_from_arctic = os.path.join(os.sep, 'home', 'prd', 'data', 'futures', 'multiple_from_arctic')
if not os.path.exists(multiple_prices_from_arctic):
    os.makedirs(multiple_prices_from_arctic)

spliced_multiple_prices = os.path.join(os.sep, 'home', 'prd', 'data', 'futures', 'multiple_prices_csv_spliced')
...
supplied_file = os.path.join(os.sep, 'home', 'prd', 'pysystemtrade', 'data', 'futures', 'multiple_prices_csv',
